return {
    ...
    },
    {
        ...
        config = function()
            ...
            vim.cmd.highlight({'BufferCurrent', 'guifg=white guibg=#282A36'})
            vim.cmd.highlight({'BufferCurrentIndex', 'guifg=white'})
            vim.cmd.highlight({'BufferInactiveIndex', 'cterm=italic gui=italic guifg=#6272a4 guibg=#191a21'})
        end,
    }
}
